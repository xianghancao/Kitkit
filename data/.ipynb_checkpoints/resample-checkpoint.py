...
class Resample():
    ...
    def build(self, Data):
        IS_Data = Object()
        OOS_Data = Object()
        if self.IS_start is not None and self.OOS_start is not None and self.IS_OOS_ratio is None:
            print(Data.dates)
            ...
            print(is_index, split_index, oos_index)
        ...
        elif self.IS_start is not None and self.OOS_end is not None and self.IS_OOS_ratio is not None:
