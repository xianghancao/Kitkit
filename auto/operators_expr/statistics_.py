...
def ts_sum(x):
    ...
    [Category] 统计
    """
    return 'ts_sum(%s,%s)' %(x, prob_engine.gen_param('ts_sum','period'))
...
def ts_product(x):
    ...
    """
    return 'ts_product(%s,%s)' %(x, prob_engine.gen_param('ts_product','period'))
...
def ts_min(x):
    ...
    """
    # 取前n天数据的最小值
    return 'ts_min(%s,%s)' %(x, prob_engine.gen_param('ts_min','period'))
...
def ts_max(x):
    ...
    [Category] 统计
    """
    return 'ts_max(%s,%s)' %(x, prob_engine.gen_param('ts_max','period'))
...
def ts_argmax(x):
    ...
    [Category] 统计
    """
    return 'ts_argmax(%s,%s)' %(x, prob_engine.gen_param('ts_argmax','period'))
...
def ts_argmin(x):
    ...
    """
    return 'ts_argmin(%s,%s)' %(x, prob_engine.gen_param('ts_argmin','period'))
...
def ts_rank(x):
    ...
    """
    return 'ts_rank(%s,%s)' %(x, prob_engine.gen_param('ts_rank','period'))
...
def ma(x):
    ...
    [Category] 统计
    """
    return 'ma(%s,%s)' %(x, prob_engine.gen_param('ma','period'))
...
def skewness(x):
    ...
    [Category] 统计
    """
    return 'skewness(%s,%s)' %(x, prob_engine.gen_param('skewness','period'))
...
def kurtosis(x):
    ...
    """
    return 'kurtosis(%s,%s)' %(x, prob_engine.gen_param('kurtosis','period'))
...
def k_moment(x):  
    ...
    计算x的滚动k阶中心距
    """
    return 'k_moment(%s,%s,%s)' %(x, prob_engine.gen_param('k_moment','period'),
                                    prob_engine.gen_param('k_moment', 'pow'))
...
def beta(high, low):
    ...
    [Category] 统计
    """
    return 'beta(%s,%s,%s)' %(high, low, prob_engine.gen_param('beta', 'period'))
...
def linearreg(x):
    ...
    [Category] 统计
    """
    return 'linearreg(%s,%s)' %(x, prob_engine.gen_param('linearreg', 'period'))
...
def linearreg_angle(x):
    ...
    [Category] 统计
    """
    return 'linearreg_angle(%s,%s)' %(x, prob_engine.gen_param('linearreg_angle', 'period'))
...
def linearreg_intercept(x):
    ...
    [Category] 统计
    """
    return 'linearreg_intercept(%s,%s)' %(x, prob_engine.gen_param('linearreg_intercept', 'period'))
...
def linearreg_slope(x):
    ...
    [Category] 统计
    """
    return 'linearreg_slope(%s,%s)' %(x, prob_engine.gen_param('linearreg_slope', 'period'))
...
def stddev(x):  # 标准差
    ...
    [Category] 统计
    """
    return 'stddev(%s,%s)' %(x, prob_engine.gen_param('stddev', 'period'))
...
def var(x):
    ...
    [Category] 统计
    """
    return 'var(%s,%s)' %(x, prob_engine.gen_param('var', 'period'))
...
def correlation(x, y):
    ...
    [Category] 统计
    """
    return 'correlation(%s,%s,%s)' %(x, y, prob_engine.gen_param('correlation', 'period'))
...
def covariance(x, y):
    ...
    [Category] 统计
    """
    return 'covariance(%s,%s,%s)' %(x, y, prob_engine.gen_param('covariance', 'period'))
...
def count_nans(x):
    ...
    """
    return 'count_nans(%s,%s)' %(x, prob_engine.gen_param('count_nans', 'period'))
...
def ts_count(cond):
    ...
    """
    return 'ts_count(%s,%s)' %(cond, prob_engine.gen_param('ts_count', 'period'))
